...
const Login = ({handleLogin}) => {
    ...
    const submitHandler = (e)=>{
        e.preventDefault() //jaise hi form submit hoga hamara page reload ho jaega(default behaviour)..isko prevent krta hai
  ...
  return (
    <div className='flex h-screen w-screen items-center justify-center'>
        <div className='border-2 rounded-xl border-emerald-600 p-20'>
            ...
            >
                <input 
                value={email}  //ye email ki vlaue daal dega..starting me default rhega
                onChange={(e)=>{
